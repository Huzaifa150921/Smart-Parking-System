...
class ExitLogs extends StatelessWidget {
  ...
  const ExitLogs({super.key, required this.puid});
                    ...
                    return FutureBuilder<Map<String, dynamic>?>(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                          ...
                          return _buildLoadingCard(plateNo, endTime);
                        }
                        ...
                        return Card(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                CircleAvatar(
                                    radius: 28, backgroundImage: imageProvider),
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(height: 4),
                                      Text("Exit Time: ${_formatTime(endTime)}",
                                          style: const TextStyle(
  ...
  Widget _buildLoadingCard(String plateNo, dynamic endTime) {
    return Card(
      elevation: 3,
      margin: const EdgeInsets.symmetric(vertical: 8),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color(0xFF0081C9).withOpacity(0.1),
                      borderRadius: BorderRadius.circular(6),
                    ),
                    child: Text("Plate No: $plateNo",
                        style: const TextStyle(
                            color: Color(0xFF0081C9),
                            fontWeight: FontWeight.w600)),
                  ),
